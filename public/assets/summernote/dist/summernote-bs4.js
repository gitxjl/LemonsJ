...
var ui_ui = function ui(editorOptions) {
  return {
    ...
    button: function button($node, options) {
      return renderer["a" /* default */].create('<button onfocus="this.blur()" style="border-radius: 3px;" type="button" class="note-btn btn btn-light btn-sm" tabindex="-1">', function ($node, options) {
